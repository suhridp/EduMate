...
function Footer() {
  return (
    <div>
      <footer className=" relative bottom-0 bg-gradient-to-t from-blue-300 to-slate-100 border-gray-200 delay-1000	transition-shadow	ease-in-out	 rounded-lg shadow dark:bg-gray-900 m-4">
